...
The authors decide to evaluate our Image Retrieval System by using the Oxford Building 5K Dataset \cite{oxbuilding}. The Oxford Building 5K Dataset consists of 5062 images collected from Flickr, has been manually annotated to generate a comprehensive ground truth for 11 differenent landmarks, each represented by 5 possible queries (55 queries in total).
