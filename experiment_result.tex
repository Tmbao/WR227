...
\begin{figure}
    \centering
    \begin{tabular}{ccc}
		\subfloat{\includegraphics[width = 1.3in]{APCS_check_0_query.png}} &
		\subfloat{\includegraphics[width = 1.3in]{APCS_2.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{APCS_3.jpg}} \\
		& \#APCS\_Party & \\
		
		\subfloat{\includegraphics[width = 1.3in]{Merlion_check_0_query.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{singapore_3.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{singapore_4.jpg}} \\
		& \#First\_time\_in\_Singapore & \\
		
		\subfloat{\includegraphics[width = 1.3in]{Hoian_check_0_query.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{hoian_7.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{hoian_11.jpg}} \\
		& \#Hoi\_An\_with\_family & \\
		
		\subfloat{\includegraphics[width = 1.3in]{ACM_check_0_query.png}} &
		\subfloat{\includegraphics[width = 1.3in]{icpc_1.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{icpc_7.jpg}}	\\
		& \#My\_favorite\_competition & \\
		
		\subfloat{\includegraphics[width = 1.3in]{thailand_check_0_query.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{thailand_3.jpg}} &
		\subfloat{\includegraphics[width = 1.3in]{thailand_4.jpg}} \\
		& \#My\_first\_Regional & \\
